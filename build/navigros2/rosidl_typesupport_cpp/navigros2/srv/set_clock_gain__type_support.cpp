...
static const _SetClockGain_Request_type_support_symbol_names_t _SetClockGain_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, navigros2, srv, SetClockGain_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, navigros2, srv, SetClockGain_Request)),
  }
};
...
{
  return &::navigros2::srv::rosidl_typesupport_cpp::SetClockGain_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, navigros2, srv, SetClockGain_Request)() {
  return get_message_type_support_handle<navigros2::srv::SetClockGain_Request>();
}
...
static const _SetClockGain_Response_type_support_symbol_names_t _SetClockGain_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, navigros2, srv, SetClockGain_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, navigros2, srv, SetClockGain_Response)),
  }
};
...
{
  return &::navigros2::srv::rosidl_typesupport_cpp::SetClockGain_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, navigros2, srv, SetClockGain_Response)() {
  return get_message_type_support_handle<navigros2::srv::SetClockGain_Response>();
}
...
static const _SetClockGain_type_support_symbol_names_t _SetClockGain_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, navigros2, srv, SetClockGain)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, navigros2, srv, SetClockGain)),
  }
};
...
{
  return &::navigros2::srv::rosidl_typesupport_cpp::SetClockGain_service_type_support_handle;
}
