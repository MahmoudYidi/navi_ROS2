...
#include "navigros2/srv/detail/set_dist__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = navigros2::srv::SetDist_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const navigros2::srv::SetDist_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<navigros2::srv::SetDist_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetDist_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const navigros2::srv::SetDist_Request *>(
...
static size_t _SetDist_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetDist_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetDist_Request__callbacks = {
  "navigros2::srv",
  "SetDist_Request",
...
static rosidl_message_type_support_t _SetDist_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetDist_Request__callbacks,
...
{
  return &navigros2::srv::typesupport_fastrtps_cpp::_SetDist_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = navigros2::srv::SetDist_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const navigros2::srv::SetDist_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<navigros2::srv::SetDist_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetDist_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const navigros2::srv::SetDist_Response *>(
...
static size_t _SetDist_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetDist_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetDist_Response__callbacks = {
  "navigros2::srv",
  "SetDist_Response",
...
static rosidl_message_type_support_t _SetDist_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetDist_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &navigros2::srv::typesupport_fastrtps_cpp::_SetDist_Response__handle;
}
...
static service_type_support_callbacks_t _SetDist__callbacks = {
  "navigros2::srv",
  "SetDist",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, navigros2, srv, SetDist_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, navigros2, srv, SetDist_Response)(),
...
static rosidl_service_type_support_t _SetDist__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetDist__callbacks,
...
{
  return &navigros2::srv::typesupport_fastrtps_cpp::_SetDist__handle;
}
